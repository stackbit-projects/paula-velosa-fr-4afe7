            ...
            <Layout page={page} config={config}>
                <div className="inner outer">
                    <header className="page-header inner-sm">
                        ...
                        {subtitle && 
                        <ul className="menu">
                            <li className="menu-item"> <button className='menu-button link current-menu-item'>Data science</button> </li>
                            <li className="menu-item"> <button className='menu-button link'>Web development</button> </li>
                            <li className="menu-item"> <button className='menu-button link'>Art</button> </li>
                        </ul>}
                    </header>
